...
/* contact.html.twig */
class __TwigTemplate_e53e876f33adb56536c265f6c7037f23a5c6efef7f769a69f26de0e9d5420df4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo "        <p id=\"Title\" class=\"h1 text-center\">Contact</p>
        <div class=\"container\">
            <div class=\"mt-5\">
                ";
        // line 11
        ...
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "vars", [], "any", false, false, false, 16), "valid", [], "any", false, false, false, 16)) {
            ...
            echo "                    <div class=\"alert alert-danger\">
                        Error: data entered are not correct
                    </div>
                ";
        }
        // line 21
        ...
        echo "
                <div class=\"row\">
                    <div class=\"col\">";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "firstname", [], "any", false, false, false, 23), 'row');
        echo "</div>
                    <div class=\"col\">";
        // line 24
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "lastname", [], "any", false, false, false, 24), 'row');
        echo "</div>
                </div>
                <div class=\"row\">
                    <div class=\"col\">";
    ...
    {
        return array (  152 => 34,  145 => 30,  140 => 28,  136 => 27,  130 => 24,  126 => 23,  120 => 21,  114 => 17,  111 => 16,  102 => 13,  99 => 12,  95 => 11,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
    ...
    {% block body %}
        <p id=\"Title\" class=\"h1 text-center\">Contact</p>
        <div class=\"container\">
            <div class=\"mt-5\">
    ...
    {% endblock %}", "contact.html.twig", "/var/www/html/Fridge_App/templates/contact.html.twig");
    }
}
