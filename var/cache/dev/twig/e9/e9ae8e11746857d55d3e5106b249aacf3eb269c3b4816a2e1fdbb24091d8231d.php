...
class __TwigTemplate_58a98cefb23ba1cacd9411b2819286b6688ea1ca9b8911c952396b290d904e8c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("admin.html.twig", "admin/user/show.html.twig", 1);
...
<div class=\"text-center\">
    ...
    <div class=\"mt-4\">
        ...
        echo "\" class=\"btn btn-primary\">back to list</a>
            <a href=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 12, $this->source); })()), "id", [], "any", false, false, false, 12)]), "html", null, true);
...
<div class=\"text-center\">
    ...
    <div class=\"mt-4\">
        ...
        {% endblock %}
", "admin/user/show.html.twig", "/var/www/html/Fridge_App/templates/admin/user/show.html.twig");
    }
}
