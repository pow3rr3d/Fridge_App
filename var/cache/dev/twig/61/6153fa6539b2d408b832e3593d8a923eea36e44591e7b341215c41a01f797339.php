...
class __TwigTemplate_5a15510a55c96b47d8217f4054229a182b9c740f0b3635b528b119838d76e22f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            if (1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["product"], "qt2Buy", [], "any", false, false, false, 49), 0)) {
                ...
                // line 58
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user.list.update", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 58)]), "html", null, true);
                echo "\">
        ...
        {% for product in products %}
            {% if product.qt2Buy > 0 %}
                <tr>
                    ...
                    <td class=\"w-25\">
                        <form method=\"post\" action=\"{{ path(\"user.list.update\", {id: product.id}) }}\">
                            <input type=\"hidden\" name=\"_method\" value=\"update\">
