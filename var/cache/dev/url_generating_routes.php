...
return [
    ...
    'admin_import_categoriesadmin_import_categories_index' => [[], ['_controller' => 'App\\Controller\\admin\\adminImportCategoriesController::index'], [], [['text', '/admin/import/categories/']], [], []],
    'admin_import_productsadmin_import_products_index' => [[], ['_controller' => 'App\\Controller\\admin\\adminImportProductsController::index'], [], [['text', '/admin/import/products/']], [], []],
    ...
    'admin_page_preview' => [['id'], ['_controller' => 'App\\Controller\\admin\\adminPageController::preview'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/page/preview']], [], []],
    ...
    'user_admin' => [['id'], ['_controller' => 'App\\Controller\\admin\\adminUserController::setAdmin'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/user']], [], []],
    'user_user' => [['id'], ['_controller' => 'App\\Controller\\admin\\adminUserController::setUser'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/user/user']], [], []],
